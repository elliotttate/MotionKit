#!/usr/bin/env python3
"""
splicekit_client.py -- Python client library for MotionKit/SpliceKit.

Connects to the JSON-RPC server running inside the host app and provides
convenience methods for ObjC runtime introspection. Also includes an
...
SPLICEKIT_HOST = os.environ.get("MOTIONKIT_HOST") or os.environ.get("SPLICEKIT_HOST") or "127.0.0.1"
SPLICEKIT_PORT = int(os.environ.get("MOTIONKIT_PORT") or os.environ.get("SPLICEKIT_PORT") or "9878")
QUIET = os.environ.get("SPLICEKIT_CLIENT_QUIET") == "1"
