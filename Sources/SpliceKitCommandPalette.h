...
@property (nonatomic, strong) NSString *bridgeSelector; // Live selector used for host-native commands
@property (nonatomic, strong) NSNumber *bridgeTag;      // Optional tag sent with the selector
